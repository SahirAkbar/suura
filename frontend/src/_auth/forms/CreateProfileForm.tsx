    ...
    <>
      ...
      <form onSubmit={handleSubmit} >
        <div className='grid grid-cols-2 gap-5 '>
          ...
          <input type="text" placeholder='Surname' className='border border-gray-400 py-1 px-2 rounded-lg  h-10' onChange={handleChange('last_name')}
        ...
        <div className='grid grid-cols-2 gap-5 mt-2 '>
          <select name="" id="" className='border border-gray-400 py-1 px-2 rounded-lg  h-10' onChange={stateChanged} >
